...
<head>
	...
	<style type="text/css">
		@media only screen and (min-width: 620px){
			* [lang=x-wrapper] h1{}* [lang=x-wrapper] h1{
			...
			* [lang=x-layout__inner] p,* [lang=x-layout__inner] ol,* [lang=x-layout__inner] ul{
...
<body class="full-padding" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;">
	...
	<div class="wrapper" style="min-width: 320px;min-height:500px;background-color: #a7a2a2;" lang="x-wrapper">
		<div class="preheader" style="margin: 0 auto;max-width: 560px;min-width: 280px; width: 280px;width: calc(28000% - 173040px);">
			<div style="border-collapse: collapse;display: table;width: 100%;text-align:center">
				<br />
				<img src="http://cursosdeespanholonline.com/img/logo.png" alt="" width="500" />
				<br /><br /><br />
			</div>
		</div>
			...
			<div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;" lang="x-layout__inner" emb-background-style>
				...
				<div class="column" style="text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
					...
					<div style="margin-left: 20px;margin-right: 20px;">
						...
						<p style="margin-top: 16px;margin-bottom: 20px;font-size: 14px;line-height: 21px;" lang="x-size-14">
							Você contratou: <br />
							Horas: <?= $horas; ?> <br />
						...
						<p class="size-14" style="margin-top: 16px;margin-bottom: 20px;font-size: 14px;line-height: 21px;" lang="x-size-14">
							Para prosseguir você precisa nos infomar alguns dados.
							<br />
                            <a href="<?= $link ?>" style="text-decoration:none;color:red;font-weight:bold">Entre neste link</a> para continuar seu cadastro. Lá você terá mais informações de como prosseguir.
                            <br>
                            <br>
                            Até mais!
						</p>
